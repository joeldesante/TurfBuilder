<script module lang="ts">
	...
	const { Story } = defineMeta({
		title: 'Components/Data Inputs/RadioGroup',
		...
		argTypes: {
			...
			items: {
				control: 'object',
				description: 'Array of radio items, each with `value`, `label`, and optional `disabled`.'
			},
			value: {
				control: 'text',
	...
	const roleItems = [
		...
		{ value: 'organizer', label: 'Field Organizer' },
		{ value: 'manager', label: 'Campaign Manager', disabled: true }
	];
</script>

<Story name="Default" args={{ label: 'Priority', items: priorityItems }} />

<Story
	name="With Preselected"
	args={{ label: 'Priority', items: priorityItems, value: 'medium' }}
/>

<Story
	name="Horizontal"
	args={{ label: 'Priority', items: priorityItems, orientation: 'horizontal' }}
/>

<Story
	name="Required"
	args={{ label: 'Priority', items: priorityItems, requirement: 'required' }}
/>
...
<Story name="Disabled" args={{ label: 'Priority', items: priorityItems, disabled: true }} />

<Story name="With Disabled Items" args={{ label: 'Role', items: roleItems }} />
