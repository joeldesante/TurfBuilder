<script lang="ts">
	import UniverseDataManagerPage from '$pages/universe/universe-data-manager-page/UniverseDataManagerPage.svelte';
	import type { ImportResult } from '$pages/universe/universe-data-manager-page/UniverseDataManagerPage.svelte';
